<!-- Accepter un avis -->
<h1 class = "center">Avis refusés</h1>
<div class="col s12">
    <div class="card">
            ...
            foreach ($tab_avis as $avis) {
                ...
                echo '<div class="col s12">
                        ...
                        <div>
	    					...
	    					<h6> 
	    				 		<a class=\'waves-effect waves-light btn\' href=\'./index.php?controller=avis&action=supprimerAvis&id=' . rawurlencode($avis->getIdAvis()) . '\'>Supprimer</a></p>
	    					</h6>
	    				</div>
                    </div>';
            }
