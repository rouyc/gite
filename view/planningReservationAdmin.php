        ...
        <div class="card">
            <div class="card-content">
                <table>
                    <tr>
                        <td colspan="7">
                            <a href="./index.php?controller=admin&action=build_admin&id=<?php echo $_GET["id"]?>&mois=<?php echo $num_mois-1; ?>&amp;annee=<?php echo $num_an; ?>"><<</a>&nbsp;&nbsp;
                            <?php echo $tab_mois[$num_mois];  ?>&nbsp;&nbsp;
                            <a href="./index.php?controller=admin&action=build_admin&id=<?php echo $_GET["id"]?>&mois=<?php echo $num_mois+1; ?>&amp;annee=<?php echo $num_an; ?>">>></a>
                        </td>

                        <td class="right">
                            <a href="./index.php?controller=admin&action=build_admin&id=<?php echo $_GET["id"]?>&mois=<?php echo $num_mois; ?>&amp;annee=<?php echo $num_an-1; ?>"><<</a>&nbsp;&nbsp;
                            <?php echo $num_an;  ?>&nbsp;&nbsp;
                            <a href="./index.php?controller=admin&action=build_admin&id=<?php echo $_GET["id"]?>&mois=<?php echo $num_mois; ?>&amp;annee=<?php echo $num_an+1; ?>">>></a>
                        </td>
                    </tr>
